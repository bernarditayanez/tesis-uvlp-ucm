...
Este repositorio contiene los scripts MATLAB utilizados para el análisis espectral de las señales adquiridas en laboratorio, junto con tablas y figuras de resultados.
